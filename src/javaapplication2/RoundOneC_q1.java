 ...
 * @author User
 */
public class RoundOneC_q1 extends javax.swing.JFrame {

    /**
     * Creates new form RoundOneC_q1
     */
    public RoundOneC_q1() {
        initComponents();
        star();
        this.setTitle("Round 1- Armstrong Number");
...
//------------------------------------ to save the complete code dynamically--------------------------
            ...
            public void run() {
                ...
                while(true){
                    try {
                        ...
                        blindCode1.write("Team: "+ob.teamName+",  Selected Question 1,  Language: 'C'\n\n");
    ...
    private void initComponents() {
        ...
        p2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/2.jpg"))); // NOI18N
        ...
        jPanel1.add(p2);
        p2.setBounds(970, 50, 370, 160);

        p6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/6.jpg"))); // NOI18N
        ...
        jPanel1.add(p6);
        p6.setBounds(980, 450, 360, 160);

        p1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/1.jpg"))); // NOI18N
        ...
        jPanel1.add(p1);
        p1.setBounds(590, 50, 370, 160);

        p3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/3.jpg"))); // NOI18N
        ...
        jPanel1.add(p3);
        p3.setBounds(600, 250, 360, 160);

        p4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/4.jpg"))); // NOI18N
        ...
        jPanel1.add(p4);
        p4.setBounds(970, 250, 360, 160);

        p5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/5.jpg"))); // NOI18N
        ...
        blindcode.setBounds(50, 330, 368, 150);
        ...
        jPanel1.add(part2);
        part2.setBounds(50, 170, 368, 154);
        ...
        jPanel1.add(part3);
        part3.setBounds(50, 490, 368, 154);
        ...
        jPanel1.add(scrol);
        scrol.setBounds(50, 330, 370, 150);
    ...
    private void part1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part1MouseClicked
        ...
        {
            case 1:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/1.jpg")));

            break;
            case 2:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/2.jpg")));

            break;
            case 3:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/3.jpg")));

            break;
            case 4:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/4.jpg")));

            break;
            case 5:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/5.jpg")));

            break;
            case 6:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/6.jpg")));
    ...
    private void part2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part2MouseClicked
        ...
        {
            case 1:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/1.jpg")));

            break;
            case 2:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/2.jpg")));

            break;
            case 3:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/3.jpg")));

            break;
            case 4:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/4.jpg")));

            break;
            case 5:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/5.jpg")));

            break;
            case 6:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/6.jpg")));
    ...
    private void part3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part3MouseClicked
        ...
        {
            case 1:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/1.jpg")));

            break;
            case 2:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/2.jpg")));

            break;
            case 3:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/3.jpg")));

            break;
            case 4:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/4.jpg")));

            break;
            case 5:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/5.jpg")));

            break;
            case 6:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q1/6.jpg")));
    ...
    private void lockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lockActionPerformed
        ...
        try{
            ...
            File doc=new File(dir+"/"+fileName.teamName+"-Round 1.doc");
            File c=new File(dir+"/round1.c");
            osDoc=new FileWriter(doc,true);
            osC=new FileWriter(c,true);
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoundOneC_q1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Create and display the form */
               ...
               RoundOneC_q1 ob= new RoundOneC_q1();
               ob.setVisible(true);
...
" void main()\n" +
"{";
    static File dir=new File("c:/SudoKodia");
    
    String s3=" int number, sum = 0, temp, remainder;\n" +
"   printf(\"Enter an integer\\n\");\n" +
"   scanf(\"%d\",number);\n" +
"   temp = number;";
    String s4=" int number, sum = 0, temp, remainder;\n" +
"   printf(\"Enter an integer\\n\");\n" +
"   scanf(\"%d\",&number);\n" +
"   temp = number;",s5=" if ( number == sum )\n" +
...
"}";
    ...
    public static javax.swing.JTextArea tablindcode;
