 ...
 * @author User
 */
public class RoundOneC_q3 extends javax.swing.JFrame {

    /**
     * Creates new form RoundOneC_q3
     */
    public RoundOneC_q3() {
        initComponents();
        star();
...
//------------------------------------ to save the complete code dynamically--------------------------
            ...
            public void run() {
                ...
                while(true){
                    try {
                        ...
                        blindCode1.write("Team: "+ob.teamName+",  Selected Question 3,  Language: 'C'\n\n");
    ...
    private void initComponents() {
        ...
        p2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/2.jpg"))); // NOI18N
        ...
        jPanel1.add(p2);
        p2.setBounds(980, 70, 370, 160);

        p6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/6.jpg"))); // NOI18N
        ...
        jPanel1.add(p6);
        p6.setBounds(980, 430, 370, 160);

        p1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/1.jpg"))); // NOI18N
        ...
        jPanel1.add(p1);
        p1.setBounds(600, 70, 370, 160);

        p3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/3.jpg"))); // NOI18N
        ...
        jPanel1.add(p3);
        p3.setBounds(600, 250, 370, 160);

        p4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/4.jpg"))); // NOI18N
        ...
        jPanel1.add(p4);
        p4.setBounds(980, 250, 370, 160);

        p5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/5.jpg"))); // NOI18N
        ...
        jPanel1.add(p5);
        p5.setBounds(600, 430, 370, 160);

        part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/part1.png"))); // NOI18N
        ...
        blindcode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/blind_code.png"))); // NOI18N
        jPanel1.add(blindcode);
        blindcode.setBounds(50, 330, 360, 150);

        part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/part2.png"))); // NOI18N
        ...
        part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/part3.png"))); // NOI18N
    ...
    private void part1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part1MouseClicked
        ...
        {
            case 1:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/1.jpg")));

            break;
            case 2:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/2.jpg")));

            break;
            case 3:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/3.jpg")));

            break;
            case 4:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/4.jpg")));

            break;
            case 5:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/5.jpg")));

            break;
            case 6:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/6.jpg")));
    ...
    private void part2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part2MouseClicked
        ...
        {
            case 1:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/1.jpg")));

            break;
            case 2:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/2.jpg")));

            break;
            case 3:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/3.jpg")));

            break;
            case 4:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/4.jpg")));

            break;
            case 5:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/5.jpg")));

            break;
            case 6:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/6.jpg")));
    ...
    private void part3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part3MouseClicked
        ...
        {
            case 1:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/1.jpg")));

            break;
            case 2:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/2.jpg")));

            break;
            case 3:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/3.jpg")));

            break;
            case 4:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/4.jpg")));

            break;
            case 5:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/5.jpg")));

            break;
            case 6:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/C/round1/q3/6.jpg")));
...
try{
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            ...
            osDoc=new FileWriter(new File(dir+"/"+fileName.teamName+"-Round 1.doc"),true);
            osBat=new FileWriter(dir+"/execute1.cmd");
            osC=new FileWriter(new File(dir+"/round1.c"),true);
            osBat.write("@echo"+"\r\n"+"tcc round1.c"+"\r\npause\r\n"+"round1");
            PrintWriter pwDoc= new PrintWriter(osDoc,false);
            PrintWriter pwC= new PrintWriter(osC,false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoundOneC_q3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
"# define SIZE 26\n" +
"void main()\n" +
"{",s2=" code statements 2";
    String s3="code statements 3";
    String s4="char s[SIZE];\n" +
"int flag=0,i,j,length;\n" +
"clrscr();\n" +
"printf(\"\\n enter the string\\n\\t\");\n" +
"gets(s);\n" +
"length=strlen(s);",s5="if(flag==1)\n" +
"	printf(\"\\n given string is not palindrome\");\n" +
"else\n" +
"	printf(\"\\n given string is palindrome\");\n" +
"getch();\n" +
"}  ",s6=" code statements 6";
