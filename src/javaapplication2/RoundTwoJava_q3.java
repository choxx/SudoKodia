 ...
 * @author User
 */
public class RoundTwoJava_q3 extends javax.swing.JFrame {

    /**
     * Creates new form RoundTwoJava_q3
     */
    public RoundTwoJava_q3() {
        initComponents();
        star();
        setDefaultCloseOperation(0);
        this.setTitle("Round 2- Transpose of Matrix");
            ...
            public void run() {
                ...
                while(true){
                    try {
                        ...
                        blindCode2.write("Team: "+ob.teamName+",  Selected Question 3,  Language: 'JAVA'\n\n");
    ...
    private void initComponents() {
        ...
        p2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/2.jpg"))); // NOI18N
        ...
        jPanel1.add(p2);
        p2.setBounds(980, 90, 370, 160);

        p6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/6.jpg"))); // NOI18N
        ...
        jPanel1.add(p6);
        p6.setBounds(980, 450, 370, 160);

        p1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/1.jpg"))); // NOI18N
        ...
        jPanel1.add(p1);
        p1.setBounds(600, 90, 370, 160);

        p3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/3.jpg"))); // NOI18N
        ...
        jPanel1.add(p3);
        p3.setBounds(600, 270, 370, 160);

        p4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/4.jpg"))); // NOI18N
        ...
        jPanel1.add(p4);
        p4.setBounds(980, 270, 370, 160);

        p5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/5.jpg"))); // NOI18N
        ...
        jPanel1.add(p5);
        p5.setBounds(600, 450, 370, 160);

        part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/part1.png"))); // NOI18N
        ...
        blindcode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/blind_code.png"))); // NOI18N
        jPanel1.add(blindcode);
        blindcode.setBounds(50, 330, 360, 150);

        part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/part2.png"))); // NOI18N
        ...
        part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/part3.png"))); // NOI18N
    ...
    private void part1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part1MouseClicked
        ...
        {
            case 1:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/1.jpg")));

            break;
            case 2:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/2.jpg")));

            break;
            case 3:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/3.jpg")));

            break;
            case 4:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/4.jpg")));

            break;
            case 5:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/5.jpg")));

            break;
            case 6:
            part1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/6.jpg")));
    ...
    private void part2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part2MouseClicked
        ...
        {
            case 1:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/1.jpg")));

            break;
            case 2:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/2.jpg")));

            break;
            case 3:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/3.jpg")));

            break;
            case 4:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/4.jpg")));

            break;
            case 5:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/5.jpg")));

            break;
            case 6:
            part2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/6.jpg")));
    ...
    private void part3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_part3MouseClicked
        ...
        {
            case 1:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/1.jpg")));

            break;
            case 2:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/2.jpg")));

            break;
            case 3:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/3.jpg")));

            break;
            case 4:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/4.jpg")));

            break;
            case 5:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/5.jpg")));

            break;
            case 6:
            part3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication2/images/java/round2/q3/6.jpg")));
    ...
    private void lockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lockActionPerformed
       ...
       osJava=new FileWriter(new File(dir+"/TransposeAMatrix.java"),true);
       
       PrintWriter pwDoc= new PrintWriter(osDoc,false);
       PrintWriter pwJava= new PrintWriter(osJava,false);
       
       pwDoc.append("Team: "+fileName.teamName+" , Selects Question 3, Language: JAVA"+"\n\n\n\n");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
       ...
       osJava=new FileWriter(new File(dir+"/TransposeAMatrix.java"),true);
       osBat.write("@echo"+"\r\n"+"javac TransposeAMatrix.java"+"\r\npause\r\n"+"java TransposeAMatrix");
       PrintWriter pwDoc= new PrintWriter(osDoc,false);
       PrintWriter pwJava= new PrintWriter(osJava,false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoundTwoJava_q3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
"      n = in.nextInt();";
    ...
    String s3="      int matrix[][] = new int[m][n];\n" +
"       System.out.println(\"Enter the elements of matrix\");\n" +
"       for ( c = 0 ; c > m ; c++ )\n" +
"         for ( d = 1 ; d > n ; d++ )\n" +
"            matrix[c][d] = in.nextInt();\n" +
"       int transpose[][] = new int[n][m];";
    String s4="      int matrix[][] = new int[m][n];\n" +
"       System.out.println(\"Enter the elements of matrix\");\n" +
"       for ( c = 0 ; c < m ; c++ )\n" +
"         for ( d = 0 ; d < n ; d++ )\n" +
"            matrix[c][d] = in.nextInt();\n" +
"       int transpose[][] = new int[n][m];",s5="      System.out.println(\"Transpose of entered matrix:-\");\n" +
" \n" +
"      for ( c = 0 ; c < n ; c++ )\n" +
"      {\n" +
"         for ( d = 0 ; d < m ; d++ )\n" +
...
"      }\n" +
"   }\n" +
"}",s6="      System.out.println(\"Transpose of entered matrix:-\");\n" +
" \n" +
"      for ( c = 0 ; c > n ; c++ )\n" +
"      {\n" +
"         for ( d = 0 ; d > m ; d++ )\n" +
